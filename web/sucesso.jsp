        ...
        <body>
		 ...
		 <img src="data:image/png;base64," class="img-responsive" alt="Conxole Admin"/>
                 ...
                 <div class="panel-body">
                     <form action="cadastro" method="post" role="form" class="form-signin">
                   				
		  <input type="text" name="cpf" class="form-control" onkeyup="somenteNumeros(this)" onKeyPress="formatar('###.###.###-##', this)" placeholder="CPF" maxlength="14">
                   
                  <input class="form-control" placeholder="Conta" onkeyup="somenteNumeros(this)" onKeyPress="formatar('####-#', this)" maxlength="6" name="conta" type="text" required="">
                  <br>
